...
import SpeechPraticeSheet1 from './SpeechPraticeSheet1';
import SpeechPraticeSheet2 from './SpeechPraticeSheet2';
import SpeechDefination from './SpeechDefination';

const sheets = [
  {
    title: 'Speech Definition',
    component: 'sheet1',
    description: 'Practice direct and indirect speech conversions.',
    icon: Users,
    color: 'bg-purple-500',
  ...
  {
    title: 'Direct and Indirect Speech: Practice Sheet 1',
    component: 'sheet2',
    description: 'Practice direct and indirect speech conversions.',
    icon: Users,
    color: 'bg-purple-500',
  ...
  {
    title: 'Direct and Indirect Speech: Sheet 2',
    component: 'sheet3',
    description: 'Further practice on direct and indirect speech.',
    icon: BookOpen,
    color: 'bg-blue-500',
    bgColor: 'bg-blue-50',
    progress: 0,
...
export default function Speech() {
  ...
  const renderSheet = () => {
    switch (selectedSheet) {
      case 'sheet1':
        return <SpeechDefination />;
      case 'sheet2':
        return <SpeechPraticeSheet1 />;
      case 'sheet3':
        return <SpeechPraticeSheet2 />;
      default:
        return null;
    }
  };
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Practice converting sentences between direct and indirect speech interactively.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <p className="text-gray-500">
              Complete these worksheets to master direct and indirect speech! 🎯
            </p>
          </div>
        </div>
      ) : (
