...
import MixPracticeSheet1 from './MixPracticeSheet1';
import MixPracticeSheet2 from './MixPracticeSheet2';

const sheets = [
  {
    title: 'Homophones and Prepositions Practice Sheet 1',
    component: 'sheet1',
    description: 'Practice identifying and using homophones and prepositions accurately.',
    icon: Users,
    color: 'bg-purple-500',
  ...
  {
    title: 'Nouns and Adjectives Practice Sheet 1',
    component: 'sheet2',
    description: 'Practice using nouns and adjectives correctly within sentences.',
    icon: BookOpen,
    color: 'bg-blue-500',
    bgColor: 'bg-blue-50',
    progress: 0,
...
export default function MixPracticeSheet() {
  const [selectedSheet, setSelectedSheet] = useState(null);

  const renderSheet = () => {
    switch (selectedSheet) {
      case 'sheet1':
        return <MixPracticeSheet1 />;
      case 'sheet2':
        return <MixPracticeSheet2 />;
      default:
        return null;
    }
  };
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          >
            ...
            <h1 className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-4">
              Homophones, Prepositions, Nouns & Adjectives Hub
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Strengthen your understanding of homophones, prepositions, nouns, and adjectives with interactive practice.
            </p>
          </motion.div>
          ...
          >
            <p className="text-gray-500">
              Complete these worksheets to master these grammar concepts! 🎯
            </p>
          </motion.div>
        </div>
      ) : (
