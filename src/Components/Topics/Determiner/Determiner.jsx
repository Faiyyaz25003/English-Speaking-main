...
import DeterminerDefination from './DeterminerDefination';

const sheets = [
  {
    title: 'Determiner Practice Sheet 1',
    component: 'sheet1',
  ...
  {
    title: 'Determiner Practice Sheet 2',
    component: 'sheet3',
    description: 'Practice advanced adverbs and placement',
    icon: BookOpen,
    color: 'bg-blue-500',
    bgColor: 'bg-blue-50',
    progress: 0,
...
export default function Determiner() {
  ...
  const renderSheet = () => {
    switch (selectedSheet) {
      case 'sheet1':
        return <DeterminerDefination />;
      case 'sheet2':
        return <DeterminersPracticeSheet1 />;
      case 'sheet3':
        return <DeterminersPracticeSheet2 />;
      default:
        return null;
    }
  };
