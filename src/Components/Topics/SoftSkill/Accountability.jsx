  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 rounded-4xl">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-16">
        ...
        {/* CTA Section */}
        <div className="text-center mt-16 bg-gradient-to-r from-indigo-500 to-purple-600 p-8 rounded-2xl shadow-lg text-white">
          <h3 className="text-2xl font-bold mb-3">Keep Growing!</h3>
          <p className="mb-4 max-w-2xl mx-auto">
            Self-awareness is the foundation of personal and professional success.
            Keep reflecting, keep improving.
          </p>
          <button className="px-6 py-2 bg-white text-indigo-600 font-semibold rounded-lg shadow hover:bg-gray-100 transition">
