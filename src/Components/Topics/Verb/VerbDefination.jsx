...
//         <h3 className="text-3xl font-semibold text-red-600 mb-2">Types of Verbs</h3>
//         {/* 1. Action Verbs */}
...
//       </div>
//  <div className="bg-green-100 max-w-6xl mx-auto p-6 text-gray-800">
//       {/* Heading */}
...
//       {/* Three Columns */}
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-[17px]">
//         {/* Column 1 */}
//         <ul className="list-decimal pl-6 space-y-2">
//           <li>Birds <strong>chirp</strong> at dawn.</li>
//           <li>Waves <strong>crash</strong> against the shore.</li>
//           <li>Children <strong>laugh</strong>.</li>
//           <li>The wind <strong>whistles</strong> through trees.</li>
//           <li>Rain <strong>patters</strong> on the roof.</li>
//           <li>Stars <strong>twinkle</strong> in the night sky.</li>
//           <li>Leaves <strong>rustle</strong> in the breeze.</li>
//           <li>Students <strong>study</strong> for exams.</li>
//           <li>Chefs <strong>cook</strong> delicious meals.</li>
//         </ul>

//         {/* Column 2 */}
//         <ul className="list-decimal pl-6 space-y-2">
//           <li>Runners <strong>sprint</strong> to the finish line.</li>
//           <li>Fish <strong>swim</strong> in the pond.</li>
//           <li>The sun <strong>shines</strong>.</li>
//           <li>The clock <strong>ticks</strong>.</li>
//           <li>Trains <strong>arrive</strong> at the station.</li>
//           <li>Actors <strong>perform</strong> on stage.</li>
//           <li>Bakers <strong>knead</strong> dough for bread.</li>
//           <li>A cat <strong>pounces</strong> on a toy.</li>
//           <li>Mechanics <strong>fix</strong> broken engines.</li>
//         </ul>

//         {/* Column 3 */}
//         <ul className="list-decimal pl-6 space-y-2">
//           <li>Athletes <strong>train</strong> for the Olympics.</li>
//           <li>Teachers <strong>explain</strong> complex topics.</li>
//           <li>Writers <strong>create</strong> new worlds.</li>
//           <li>Flowers <strong>bloom</strong> in spring.</li>
//           <li>Bees <strong>buzz</strong> around flowers.</li>
//           <li>Snowflakes <strong>drift</strong> to the ground.</li>
//           <li>The moon <strong>glows</strong> in the dark.</li>
//           <li>Drummers <strong>beat</strong> their drums.</li>
//           <li>The fire <strong>crackles</strong>.</li>
//         </ul>
//       </div>
//     </div>
...
const VerbDefinition = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans text-gray-900">
      ...
      <div className="flex items-center space-x-2 mb-4">
        <span className="text-2xl">🌟</span>
        <h1 className="text-4xl font-extrabold text-red-600">Verb</h1>
      </div>
      ...
      {/* Examples of Verbs */}
      <div className="bg-green-100 max-w-6xl mx-auto p-6 text-gray-800">
        <h2 className="text-3xl font-semibold text-purple-600 mb-6">Examples of Verbs</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-[17px]">
          {/* Column 1 */}
          <ul className="list-decimal pl-6 space-y-2">
            <li>Birds <strong>chirp</strong> at dawn.</li>
