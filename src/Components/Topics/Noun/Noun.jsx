...
import CollectiveNoun from './CollectiveNoun';
import CommonProperNounSheet1 from './CommonAndProperNoun';
import ConcreteAndAbstractNoun from './ConcreteAndAbstractNoun';
import PluralNoun from './PluralNoun';
import SpecialPluralNoun from './SpecialPluralNoun';
...
const sheets = [
  ...
  {
    title: 'Concrete and Abstract Noun',
    component: 'concrete',
    description: 'Explore tangible and intangible concepts',
    icon: Lightbulb,
    color: 'bg-green-500',
    bgColor: 'bg-green-50',
    progress: 0,
  },
  {
    title: 'Plural Nouns',
    component: 'plural',
    description: 'Practice forming plural forms of nouns',
    icon: Target,
    color: 'bg-orange-500',
  ...
  {
    title: 'Special Plural Noun',
    component: 'specialPlural',
    description: 'Master irregular plural forms and exceptions',
    icon: Award,
    color: 'bg-red-500',
    bgColor: 'bg-red-50',
    progress: 65,
...
export default function Noun() {
  ...
  const renderSheet = () => {
    switch (selectedSheet) {
      ...
      case 'common':
        return <CommonProperNounSheet1 />;
      case 'concrete':
        return <ConcreteAndAbstractNoun />;
      case 'plural':
        return <PluralNoun />;
      case 'specialPlural':
        return <SpecialPluralNoun />;
      default:
        return null;
    }
  };
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Master in different types of nouns with interactive exercises and engaging activities
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <button className="w-full bg-purple-500 hover:bg-pink-400 text-gray-700 font-semibold py-3 px-6 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-all duration-200 shadow-sm group-hover:shadow-md">
                    {sheet.title === 'Special Plural Noun' ? 'Start' : (sheet.progress > 0 ? 'Continue' : 'Start')}
                  </button>
                </div>
              );
            })}
          ...
          <div className="text-center mt-16">
            <p className="text-gray-500">
              Complete all worksheets to become a noun expert! 🎯
            </p>
          </div>
        </div>
      ) : (
