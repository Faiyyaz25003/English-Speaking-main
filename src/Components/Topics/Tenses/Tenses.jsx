...
import TenseDefination from './TenseDefination';
...
const sheets = [
  ...
  },
  {
    ...
    component: 'sheet4',
    description: 'Practice past tense sentence formation.',
    icon: Award,
    color: 'bg-green-500',
    bgColor: 'bg-green-50',
    progress: 0,
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Practice past and present tenses with interactive worksheets
            </p>
          </div>
